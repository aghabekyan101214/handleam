    ...
    <div class="content-wrap">
        <div class="content">
                        ...
                        <div class="row tax-coupon-div">
                                    ...
                                    <div class="tax-coupon-details tab-content">
                                        <div id="tax" class="shipping-dec tab-pane active">
                                            ...
                                            <div class="shipping-form">
                                                ...
                                                <div class="single-shipping-botton" data-toggle="modal"
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="cart-total">
                                    <ul>
                                        <li class="cart-black"><?= $cnt->val['total'] ?><span class="pay_total"
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <th class="product-price text-center"
                                                style="padding:60px 0;background:#fff;">Ձեր զամբյուղը դատարկ է<br><br><a
                                                        href="/shop" class="btn btn-default">« Վերադառնալ</a></th>
                                        </tr>
                                        </thead>
                                    </table>
                                </div>
                                    ...
                                    <div class="d-tablecell">
                                        <div class="modal-dialog">
                                            <div class="main-view modal-content"
                                                 style="width: 50% !important; margin: 0 auto;">
                                                ...
                                                <div class="tax-coupon-all">
                                                    ...
                                                    <div class="tax-coupon-details tab-content center-block"
                                                            ...
                                                            <div class="shipping-form">
                                                                <div class="single-shipping-form">
                                                                    <input type="text" name="name"
                                                                           placeholder="<?= $cnt->val['fname_lname'] ?>"><br><br>
                                                                    <input type="text" name="address"
                                                                           placeholder="<?= $cnt->val['order_address'] ?>"><br><br>
                                                                    <input type="text" name="phone"
                                                                           placeholder="<?= $cnt->val['phone_phd'] ?>"><br><br>
                                                                </div>
            ...
            <form action="https://banking.idram.am/Payment/GetPayment" method="post" style="display: none" id="idram-form">
                <input type="hidden" name="EDP_LANGUAGE" value="<?= strtoupper($_SESSION['lang']); ?>">
